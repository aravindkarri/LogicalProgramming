package com.bridgelabz.logical_programming_problems.vendingmachine;
...
public class VendingMachine {
	...
	public static void main(String[] args) {
		...
		System.out.println("Please enter amount to calculte minimum number of notes to get return :");
